...
#
# @callback(
#     [Output('analyzed-expression-select-statistics-divided', 'data'), Output('analyzed-expression-select-statistics-divided', 'value')],
...
#         expression_values = [real_tier_lists[expression_divided]['Replace_Value'], str("No_" + real_tier_lists[expression_divided]['Replace_Value'])]
#     else:
...
#                         fig1_temp, df1_temp = plot_absolute_duration_from_tier(expression_divided, entity,expression_analyzed, statistic, name_databases)
...
#                     figures = []
#                     for entity in expression_values:
#                         fig1_temp, df1_temp = plot_relative_duration_from_tier(expression_divided, entity, expression_analyzed, statistic, name_databases)
...
#             if type == "absolute":
#                 for entity in expression_values:
#                     fig1_temp = plot_absolute_duration_from_tier(expression_divided, entity, expression_analyzed, statistic, name_databases)
#                     figures.extend(fig1_temp)
#                     print(entity)
#             else :
#                 for entity in expression_values:
#                     fig1_temp = plot_relative_duration_from_tier(expression_divided, entity, expression_analyzed, statistic, name_databases)
#                     figures.extend(fig1_temp)

...
def display_specific_informations(database, tier, intensities) :
    ...
    Returns:
        list: list of tuples with the name of the file, the duration of the file, the min time of the tier, the max time of the tier and the number of intensities
    """
    lst = []
